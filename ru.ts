export const RU = {
    ...
    TranslatorName: "Чеширский Кот, WingedLeo, Ree",
    Language: "Язык",
    ...
    OperatingSystem: "Операционная иистема",
    OperatingSystemCompany: "Студия разработки ОС",
    ...
    SoftwareCompany: "Студия разработки ПО",
    ...
    FreeTransportToTradeCenterDesc:
        "Перевозка в Центр торговли бесплатная, но перевозка из него на 50% дороже",
    ...
    AchievementsReward: "Награда: франки +%{swiss}",
    AchievementsRewardToast: "Вы получили вознаграждение: франки +%{swiss}",
    AchievementsClaim: "Получить",
    AchievementsToast: "Вы получили достижение «%{name}». Получите свою награду в Центральном офисе",
    AchievementStockholm100: "Начинающий викинг",
    AchievementStockholm100Desc: "Заработай 100 франков в Стокгольме за одну сессию",
    AchievementStockholm500: "Продвинутый викинг",
    AchievementStockholm500Desc: "Заработай 500 франков в Стокгольме за одну сессию",
    AchievementStockholm1000: "Опытный викинг",
    AchievementStockholm1000Desc: "Заработай 1000 франков в Стокгольме за одну сессию",
    AchievementOslo100: "Норвежский нефтяной любитель",
    AchievementOslo100Desc: "Заработай 100 франков в Осло за одну сессию",
    AchievementOslo500: "Норвежский нефтяной энтузиаст",
    AchievementOslo500Desc: "Заработай 500 франков в Осло за одну сессию",
    AchievementOslo1000: "Норвежский нефтяной магнат",
    AchievementOslo1000Desc: "Заработай 1000 франков в Осло за одну сессию",
    AchievementRotterdam100: "Владелец вертушки",
    AchievementRotterdam100Desc: "Заработай 100 франков в Роттердаме за одну сессию",
    AchievementRotterdam500: "Владелец ветряной мельницы",
    AchievementRotterdam500Desc: "Заработай 500 франков в Роттердаме за одну сессию",
    AchievementRotterdam1000: "Владелец ветрового генератора",
    AchievementRotterdam1000Desc: "Заработай 1000 франков в Роттердаме за одну сессию",
    AchievementDetroit100: "Местный автодилер",
    AchievementDetroit100Desc: "Заработай 100 франков в Детройте за одну сессию",
    AchievementDetroit500: "Региональный автомобильный дистрибьютор",
    AchievementDetroit500Desc: "Заработай 500 франков в Детройте за одну сессию",
    AchievementDetroit1000: "Национальная автомобильная монополия",
    AchievementDetroit1000Desc: "Заработай 1000 франков в Детройте за одну сессию",
    AchievementBoston100: "Бакалавр по зарабатыванию денег",
    AchievementBoston100Desc: "Заработай 100 франков в Бостоне за одну сессию",
    AchievementBoston500: "Магистр по зарабатыванию денег",
    AchievementBoston500Desc: "Заработай 500 франков в Бостоне за одну сессию",
    AchievementBoston1000: "Доктор наук по печатанию денег",
    AchievementBoston1000Desc: "Заработай 1000 франков в Бостоне за одну сессию",
    AchievementRome100: "Диоклетиан",
    AchievementRome100Desc: "Заработай 100 франков в Риме за одну сессию",
    AchievementRome500: "Константин Великий",
    AchievementRome500Desc: "Заработай 500 франков в Риме за одну сессию",
    AchievementRome1000: "Октавиан Август",
    AchievementRome1000Desc: "Заработай 1000 франков в Риме за одну сессию",
    AchievementHamburg100: "Германия",
    AchievementHamburg100Desc: "Заработай 100 франков в Гамбурге за одну сессию",
    AchievementHamburg500: "Отечество",
    AchievementHamburg500Desc: "Заработай 500 франков в Гамбурге за одну сессию",
    AchievementHamburg1000: "Граф Цеппелин",
    AchievementHamburg1000Desc: "Заработай 1000 франков в Гамбурге за одну сессию",
    AchievementToulouse100: "Airbus A310",
    AchievementToulouse100Desc: "Заработай 100 франков в Тулузе за одну сессию",
    AchievementToulouse500: "Airbus A330",
    AchievementToulouse500Desc: "Заработай 500 франков в Тулузе за одну сессию",
    AchievementToulouse1000: "Airbus A380",
    AchievementToulouse1000Desc: "Заработай 1000 франков в Тулузе за одну сессию",
    AchievementHongKong100: "Трейдер-любитель",
    AchievementHongKong100Desc: "Заработай 100 франков в Гонконге за одну сессию",
    AchievementHongKong500: "Профессиональный брокер",
    AchievementHongKong500Desc: "Заработай 500 франков в Гонконге за одну сессию",
    AchievementHongKong1000: "Управляющий хедж-фондом",
    AchievementHongKong1000Desc: "Заработай 1000 франков в Гонконге за одну сессию",
    AchievementStPetersburg100: "Великий князь",
    AchievementStPetersburg100Desc: "Заработай 100 франков в Санкт-Петербурге за одну сессию",
    AchievementStPetersburg500: "Царевич",
    AchievementStPetersburg500Desc: "Заработай 500 франков в Санкт-Петербурге за одну сессию",
    AchievementStPetersburg1000: "Царь всея Руси",
    AchievementStPetersburg1000Desc: "Заработай 1000 франков в Санкт-Петербурге за одну сессию",
    AchievementOsaka100: "Дансяку",
    AchievementOsaka100Desc: "Заработай 100 франков в Осаке за одну сессию",
    AchievementOsaka500: "Хакусяку",
    AchievementOsaka500Desc: "Заработай 500 франков в Осаке за одну сессию",
    AchievementOsaka1000: "Косяку",
    AchievementOsaka1000Desc: "Заработай 1000 франков в Осаке за одну сессию",
    ...
    DatabaseCompany: "Компания ''Database''",
    Database: "База данных",
    SatelinkInc: "Корпорация ''Satelink''",
    GameStationInc: "Корпорация 'GameStation'",
    AirShuttleInc: "Корпорация 'Air Shuttle'",
    AircraftCarrierFactory: "Верфь авианосцев",
    ...
    MarketNewsApplyToYou: "Только для вас",
    ...
    MarketNewsBuilding: "На это здание влияют новости рынка (%{num})",
    StockholmBonusV2:
    ...
    FreeOilTransportV2: "Электротранспорт для нефти",
    Tutorial4P1:
    ...
    Tutorial4P2:
        "Вы можете изменить тип топлива в <em>отделе логистики🚦</em> - на этой карте вы также можете использовать <em>природный газ</em> в качестве топлива.<br><br>Отдел логистики также показывает ваши транспортные маршруты, которые сжигают больше всего топлива - вы должны следить за ними.<br><br><em>Убедитесь, что производство топлива превышает его потребление</em>, иначе ваше производство остановится, когда у вас закончится топливо.<br><br> Если это произойдет, не волнуйтесь, вы можете купить немного дополнительного топлива в Центре торговли или у других игроков",
    Tutorial5P2:
        "<em>Бюро статистики📊</em> предоставляет хороший обзор вашего производства. Вы можете увидеть подробную разбивку вводимых и выводимых ресурсов.<br><br>Там также много полезных графиков📈 - возможно, вы захотите обратиться к ним, когда будете балансировать производство.<br></br>Ваши <em>деньги💰, избыток энергии⚡ и избыток топлива⛽</em> также показаны в левом верхнем углу - если любой из них становится красным, вам следует выяснить, что происходит.",
    ...
    SellRefundPercentage: "Компенсация за понижение уровня/продажу",
    ...
    SellBuildingDescV2:
        "При продаже здания вам будет возвращено %{percent} ваших вложений, %{percent} ресурсов будет перевезено в Центр торговли",
    BuilderMoveSpeed: "Скорость перемещения строителей",
    BuilderMoveSpeedDesc: "Скорость, с которой перемещаются строители к зданиям",
    ...
    BuildWarningBuildAnyway: "Всё равно построить",
    ...
    AllTimeSwissMoneyEarned: "Заработанные за все время франки: %{number}",
    BuildingUpgradeCostDivider: "Делитель стоимости модернизации здания",
    AchievementSoftwareGiant: "ПО-гигант",
    AchievementSoftwareGiantDesc:
        "Постройте на одной карте Студию разработки ПО 10 уровня, Студию разработки ОС 10 уровня, Компанию ''Database'' 10 уровня и Веб-браузер 10 уровня",
    ...
    LogoutDescV2:
        "Вы вошли в аккаунт на другом устройстве. Это устройство отключено от системы. Вы можете снова войти, но другое устройство будет отключено.",
    LogBackIn: "Войти снова",
    ServerDisconnected: "Вы отключены от сервера. Проверьте подключение к Интернету и перезапустите игру",
    ...
    BlockUserChatDesc:
        "Блокировка будет действовать в течение этой игровой сессии. Вы не сможете отменить это, пока не перезапустите игру",
    ...
    Radar: "Радар",
    SpaceForceCommand: "Командование космическими силами",
    ...
    BuildingPermitsNeededDesc: "Это здание не работает, т. к. у вас недостаточно разрешений на строительство",
    BuildingPermitsNeeded: "Требуются разрешения на строительство",
    BuyMissingPermits: "Купить недостающие разрешения",
    GPUIsBusy: "Ваш графический процессор занят",
    GPUIsBusyDesc:
        "Ваша операционная система приостановила обработку графики игры, т. к. графический процессор занят другими задачами. Вы можете перезагрузить игру, чтобы продолжить. Если это не сработает, попробуйте перезапустить игру",
    ...
    AchievementVancouver100Desc: "Заработайте 100 франков в Ванкувере за одну сессию",
    AchievementVancouver500: "Специалист по сиропу",
    AchievementVancouver500Desc: "Заработайте 500 франков в Ванкувере за одну сессию",
    AchievementVancouver1000: "Покоритель Канады",
    AchievementVancouver1000Desc: "Заработайте 1000 франков в Ванкувере за одну сессию",
    ...
    DoubleTileModifierDescV2:
        "Эффект всех модификаторов плитки 2Х — и положительный, и отрицательный. Эта политика деактивирует политику Плоская Земля",
    ...
    GetHelpSteamGuides: "Другие руководства в Steam",
    GetHelpInGameChat: "Спросить в игровом чате",
    GetHelpDiscord: "Присоединяйтесь к нашему серверу Discord",
    ...
    TotalPledgedValueDesc:
        "Ваш первый залог учитывается при достижении Краудфандинг. Последующие взносы увеличивают общую объявленную стоимость, но не учитываются при достижении цели",
    ReturnOnPledge: "Возврат залога",
    CrowdfundingEndIn: "Закроется через %{time}",
    ClaimCrowdfundingReward: "Получить награду: %{amount}",
    PledgeSuccessful: "Вы заложили %{amount} в краудфандинг",
    CrowdfundingClaimSuccessful: "Вы получили %{amount} денег",
    CrowdfundingAlreadyPledged: "Вы уже внесли залог",
    CrowdfundingAlreadyPledgedDesc:
        "Вы можете заложить больше ресурсов, что увеличит ваш общий залог (и потенциальную прибыль), но не будет засчитано в достижении краудфандинга",
    WholesaleCenterProducingOnly: "Оптовые партнеры",
    WholesaleCenterProducingOnlyDesc:
        "Заказы в центре оптовой торговли содержат только те ресурсы, которые относятся к верхней половине наиболее продвинутых исследованных вами продуктов (вам также необходимо производить необходимое количество ресурсов, чтобы разблокировать Центр оптовой торговли).",
    ...
    Battleship: "Линкор",
    BattleshipFactory: "Верфь линкоров",
    ...
    ResourceMovement: "Транспортировка ресурсов",
    ...
    CrowdfundingCashInWarning:
        "Вы участвуете в краудфандинге — при старте в новом городе ваше участие будет отменено",
    ResourceBoosterBannerDescV2:
        "💡 У вас есть ресурсные ускорители (%{number} шт.) — научный вклад каждого из них увеличивается в соответствии с количеством ресурсных ускорителей, которые у вас есть в данный момент.",
    CrowdfundingId: "Краудфандинг %{id}",
    PatchNotes: "Инфо. о патче",
    ...
    HighPowerPriorityDesc:
        "Включение этого параметра позволит этому зданию получать энергию в первую очередь",
    IndustryZone: "Промышленная зона",
    IndustryZoneDesc:
        "Объединение соседних зданий, образующее цепочку поставок и экономящее разрешения на строительство",
    ...
    GameCloudInc: "Корпорация ''GameCloud''",
    ...
    PolicySearchPlaceholder: "Введите название политики",
    SwissUpgrade: "Улучшение за франки",
    SwissUpgradeDesc: "Улучшения за кредиты сохраняются и переносятся, если вы начинаете в новом городе",
    SwissBoost: "Усиление за франки",
    SwissBoostDesc: "Усиления за франки действуют только в текущем городе и обнуляются при старте в новом городе",
    ProductionMultipliers: "Производственные множители",
    MultiplierMapUniqueBonus: "Уникальный бонус карты",
    MultiplierSwissUpgrade: "Улучшение за франки (Постоянно)",
    MultiplierSwissBoost: "Усиление за франки (Текущая сессия)",
    SwissBoostCostDivider: "Делитель стоимости Усиления за франки",
    SwissBoostCostDividerDesc:
        "Уменьшите стоимость Усиления за франки на этот коэффициент — применяется только к усилениям с множителями/делителями",
    ...
    HighSpeedWarehouse: "Ускорение работы склада",
    ...
    ChipManufacturer: "Производитель чипов",
    SnapTokInc: "Корпорация SnapTok",
    FaceAppInc: "Корпорация FaceApp",
    BitcoinMiner: "Майнер биткоинов",
    GalvanicBatteryFactory: "Завод гальванических элементов",
    ...
    CrowdfundingBackersReturn: "Спонсоры: %{backers}, текущая доходность: %{return}",
    CrowdfundingBackersNeeded: "Спонсоров осталось: %{backers}",
    CrowdfundingReturnBonus: "Доходность +%{return}",
    ...
    AchievementSanJose100Desc: "Заработайте 100 франков в Сан-Хосе за одну сессию",
    AchievementSanJose500: "Венчурный энтузиаст",
    AchievementSanJose500Desc: "Заработайте 500 франков в Сан-Хосе за одну сессию",
    AchievementSanJose1000: "Венчурный капиталист",
    AchievementSanJose1000Desc: "Заработайте 1000 франков в Сан-Хосе за одну сессию",
    ...
    AchievementCashIsKingDesc: "Получите 1Qa денег за одну сессию",
    AchievementPowerTycoon: "Энергетический магнат",
    AchievementPowerTycoonDesc: "Выработайте 1 ГВт энергии за одну сессию",
    ...
    LeaderboardOptOutDescV2:
        "Вы больше не будете отображаться в таблице лидеров. Это также отключит торговлю игроками. ОБРАТИТЕ ВНИМАНИЕ: если вы хотите включить таблицу лидеров позже, ваши данные должны быть сброшены",
    ...
    MetaRebrandingDesc:
        "Корпорация ''Социальная сеть'' переименовывается в Корпорацию ''Мета'' и потребляет Интернет, Игры, Суперкомпьютер, Биткоин и Догикоин",
    MetaInc: "Корпорация ''Мета''",
    ImportSave: "Импорт сохранения",
    ClearMyTrades: "Очистить мои сделки",
    SaveVersionTooNew:
        "Ваше сохранение для версии %{saveVersion}, но версия вашей игры %{gameVersion}. Пожалуйста, обновите свою игру",
    ...
    LeaderboardByFlagPayerSwissMoney: "Франки",
    PlayerTradePriceFilter: "Фильтр по цене",
    ...
    BuildingSourceInvalid: "Выбранный вами источник не подходит, пожалуйста, выберите правильную плитку",
    RandomIsland: "Случайный остров",
    RandomIslandBonus:
        "<li>Карта случайная каждый раз, когда вы начинаете</li><li>Размер карты, тип сетки, состав и расположение ресурсов, уникальные бонусы выпадают случайным образом</li><li>Существует 5-минутная задержка — повторная генерация происходит не раньше, чем раз в 5 минут</li>",
    ...
    RandomIslandBonusResources: "Месторождений на этой карте: %{deposits}",
    ValuationPerActiveMinute: "Оценка за минуту активности",
    Perth: "Перт",
    ...
    OwnDLC: "Расширений в наличии: %{number}",
    GeneralServerSuccessMessage: "Ваш запрос был успешно выполнен",
    GeneralServerErrorMessage: "Ошибка сервера: %{error}",
    ...
    Dam: "Плотина",
    DamDesc: "Плотина превращает соседние пустые плитки в плитки с водой",
    Farmland: "Ферма",
    ...
    FarmlandOfflineFarmingDesc:
        "Фермы, построенные на естественных водных источниках, продолжают выработку продукции даже когда вы в оффлайне. Подпадают под ограничения на продолжительность оффлайн-заработка, а также под влияние улучшений за швейцарские деньги",
    ...
    ShowSupplyChainDesc:
        "При выделении здания отобразится вся цепочка поставок от всех зданий, расположенных выше и ниже в цепи производству",
    Cake: "Торт",
    ...
    StandbyModeDesc:
        "Симуляция игры будет продолжать работать в фоновом режиме, но графика не будет отображаться. Это значительно снизит нагрузку на GPU и CPU.",
    ...
    Hotdog: "Хот-дог",
    BatchOperationDesc:
        "Это будет применено к зданиям: %{number}. Примерная стоимость составляет $%{cost}. Продолжить?",
    ...
    StreamAutoApproveDesc:
        "Позволяет игрокам присоединяться к вашему стриму без запроса",
    ...
    BatchModeAll: "все",
    BatchModeAdjacent: "прилегающие",
    BatchModeCluster: "кластер",
    BatchUpgradeToLevelX: "до уровня %{level}",
    ApplyToBatch: "Применить: %{batch}",
    BatteryRecycler: "Переработчик аккумуляторов", 
    BatteryShell: "Корпус аккумулятора",
    StartInANewCity: "Начать в новом городе",
    StartInANewCityFinePrint: "(Или сбросьте ваш текущий город)",
    BatteryFuelDesc:
    ...
    DefenseModuleCriticalDamageMultiplierShort: "Крит. урон х",
    ...
    WaveInProgressBuildRemoveDisabled:
        "Вы не можете строить здания на пути или продавать здания, когда идет вторжение",
    ExportSaveForTransfer: "Перенести сохранение",
    ...
    RightToTradeValid: "Торговля разрешена",
    RightToTradeInvalid: "Торговля запрещена",
    RightToTradeInvalidDesc:
        "Это происходит потому, что ваше право на торговлю было экспортировано в другой файл сохранения — вам следует импортировать этот файл, чтобы восстановить право на торговлю. Если вы потеряли тот файл, вы можете принудительно восстановить право на торговлю в этом сохранении, но на вас будет наложен временное ограничение, а ваше другое сохранение потеряет право на торговлю.",
    ForceRestoreRightToTrade: "Принудительное восстановление (Ограничение на %{cooldown} час(ов))",
    ImportSaveRestoreFail: "Не удалось подключиться к серверу. Пожалуйста, проверьте соединение с Интернетом.",
    DefenseCommandConvertDesc: "Конвертировать ресурсы в урон по текущей цене торгового центра",
    MousewheelSensitivity: "Чувствительность масштабирования колесом мыши",
    MousewheelSensitivityDesc:
        "Настройка чувствительности при прокрутке колеса мыши для увеличения/уменьшения масштаба",
    PlayerTradeFilterWhatIHave: "Фильтровать то, что в наличии",
    PathTemporarilyBlocked:
        "Вы не можете строить на этой плитке, так как идет волна. Попробуйте еще раз после окончания волны",
    MoveBuilding: "Переместить здание",
    MoveBuildingInvalidTarget: "Не удалось переместить здание — выбранная плитка не подходит",
    MoveBuildingMoving: "Выберите пустую плитку...",
    WaveAutoNext: "Автозапуск",
    WaveAutoNextDesc: "После успешного сдерживания волны автоматически собирает награду и начинает следующую",
    IstanbulBonus:
        "<li>Режим защиты башни — конвертируйте оружие в урон, защищайтесь от противников и получайте денежные вознаграждения для дальнейшего развития</li><li>Командования армией имеют 2x мощности</li><li>Танкостроительные заводы имеют 2x мощности</li><li>Оружейные заводы имеют 2x мощности</li><li>Завод снарядов имеют 2x мощности</li><li>Динамитные фабрики имеют 2x мощности</li>",
    PlayerTradeCancelTitle: "Отменить эту сделку?",
    PlayerTradeCancelDescV2: "Налог, уплаченный по данной сделке, возврату НЕ ПОДЛЕЖИТ",
    PlayerTradeCancelYes: "Отменить сделку",
    PlayerTradeCancelNo: "Не отменять",
    SteamAutoCloudBackupDescV3:
        "Ваш прогресс сохраняется в Steam Cloud. Игра также создает резервные копии каждые 10 минут — вы можете принудительно создать её в любое время. Загрузка резервной копии приведет к потере права на торговлю и потребует принудительного восстановления (применится таймер ожидания).",
    BuyFromTradeCenter: "Купить в центре торговли",
    ...
    PlayerTradesAvailable: "Сделкок доступно у игроков: %{number}",
    ...
    AccountTrusted: "Ограничения не применяются",
    AccountLimited: "Есть ограничения аккаунта",
    AntiCheatPass: "Анти-чит: успешно",
    AntiCheatFail: "Анти-чит: провалено",
    AchievementIstanbul100: "Лев Великий",
    AchievementIstanbul100Desc: "Заработайте 100 франков в Стамбуле за одну сессию",
    AchievementIstanbul500: "Юстиниан Великий",
    AchievementIstanbul500Desc: "Заработайте 500 франков в Стамбуле за одну сессию",
    AchievementIstanbul1000: "Константин Великий",
    AchievementIstanbul1000Desc: "Заработайте 1000 франков в Стамбуле за одну сессию",
    AchievementPerth100: "Филандер",
    AchievementPerth100Desc: "Заработайте 100 франков в Перте за одну сессию",
    AchievementPerth500: "Валлаби",
    AchievementPerth500Desc: "Заработайте 500 франков в Перте за одну сессию",
    AchievementPerth1000: "Кенгуру",
    AchievementPerth1000Desc: "Заработайте 1000 франков в Перте за одну сессию",
    AchievementKansasCity100: "Кукуруза в початках",
    AchievementKansasCity100Desc: "Заработайте 100 франков в Канзас-Сити за одну сессию",
    AchievementKansasCity500: "Корн-дог",
    AchievementKansasCity500Desc: "Заработайте 500 франко в Канзас-Сити за одну сессию",
    AchievementKansasCity1000: "Попкорн",
    AchievementKansasCity1000Desc: "Заработайте 1000 франков в Канзас-Сити за одну сессию",
    AchievementRioDeJaneiro100: "Леблон",
    AchievementRioDeJaneiro100Desc: "Заработайте 100 франков в Рио-де-Жанейро за одну сессию",
    AchievementRioDeJaneiro500: "Барра-да-Тижука",
    AchievementRioDeJaneiro500Desc: "Заработайте 500 франков в Рио-де-Жанейро за одну сессию",
    AchievementRioDeJaneiro1000: "Копакабана",
    AchievementRioDeJaneiro1000Desc: "Заработайте 1000 франков в Рио-де-Жанейро за одну сессию",
    AchievementRandomIsland100: "Бернулли",
    AchievementRandomIsland100Desc: "Заработайте 100 франков на Острове Рандом за одну сессию",
    AchievementRandomIsland500: "Пуассон",
    AchievementRandomIsland500Desc: "Заработайте 500 франков на Острове Рандом за одну сессию",
    AchievementRandomIsland1000: "Гаусс",
    AchievementRandomIsland1000Desc: "Заработайте 1000 франков на Острове Рандом за одну сессию",
    ...
    PanelHeightDesc:
        "Выберите высоту панели. Работает только в портретном режиме на мобильных устройствах. ТРЕБУЕТСЯ ПЕРЕЗАГРУЗКА!",
    ...
    MineBoosterDesc:
        "Работающая шахта дает 100% прибавку к мощности соседним шахтам или фабрикам, которые разрабатывают месторождение",
    ...
    AccountLimitedActionV2: "Прочитать FAQ об Ограничении аккаунтов",
    ...
    HydroFarmingDesc: "Каждая работающая гидроэлектростанция дает 20% прирост мощности всем фермам и теплицам на карте",
    ...
    AutoSellCapacityMultiplierDescV2:
        "Это даст возможность автоматически продавать за раз больше ресурсов, чем позволяет текущий лимит.",
    ...
    AutoSellCapacityExtraPercentageFromSwiss: "Дополнительный процент от Улучшения и Усиления за франки: %{n}%",
    BaselineAutoSellCapacity: "Базовая мощность автопродажи: %{amount}",
    AchievementAuckland100: "Желтоглазый пингвин ",
    AchievementAuckland100Desc: "Заработайте 100 франков в Окленде за одну сессию",
    AchievementAuckland500: "Синяя утка",
    AchievementAuckland500Desc: "Заработайте 500 франков в Окленде за одну сессию",
    AchievementAuckland1000: "Киви",
    AchievementAuckland1000Desc: "Заработайте 1000 франков в Окленде за одну сессию",
    ...
    MREPlant: "Фабрика блюд, готовых к употреблению",
    ...
    PlayerTradeTaxCreditMarketCapDesc:
        "Этот налоговый кредит состовляет %{percentage} от вашей рыночной капитализации, может быть улучшен через Улучшение/Усиление за франки. Общая сумма кредита составляет %{total}, использовано %{used}",
    PlayerTradeGrossTradeValue: "Общая стоимость",
    ...
    PlayerTradeTradeValueAfterTax: "Стоимость после уплаты налогов",
    ...
    WaterProductionx2: "Водяной супернасос",
    ...
    InputBuffer: "Запас входных ресурсов",
    InputBufferDesc:
        "Максимальное количество циклов входного ресурса, которое необходимо хранить в складе, прежде чем это здание перестанет транспортировать этот ресурс. «Авто» означает прогнозирования для поддержания минимального количества ресурсов, позволяющего непрерывно работать. «Запас» означает постоянную транспортировку входных ресурсов, независимо от их количества на складе",
