export const RU = {
    ...
    BuildingUnlocked: "Разблокировано здание: %{building}",
    Science: "Наука",
    ...
    Colosseum: "Колизей",
    WindTurbine: "Ветровой генератор",
    Engine: "Двигатель",
    ...
    Aircraft: "Самолёт",
    AircraftFactory: "Самолётостроительный завод",
    Zeppelin: "Дирижабль",
    ZeppelinFactory: "Завод дирижаблей",
    Tank: "Танк",
    TankFactory: "Танкостроительный завод",
    ...
    BuildingPermitDesc:
        "Приобретено разрешений на строительство зданий: %{amount}. Использовано разрешений: %{amountBuilt}. Осталось разрешений: %{amountLeft}",
    BuildingLocked: "Здание не доступно. Вы должны разблокировать его в исследовательской лаборатории",
    MaxBuilders: "Максимум строителей",
    MaxBuildersDesc: "Количество зданий, которые вы можете строить одновременно",
    Silicon: "Кремний",
    ...
    Santa: "Санта-Клаус",
    Car: "Автомобиль",
    CarFactory: "Машиностроительный завод",
    Ship: "Корабль",
    SolarPanel: "Солнечная панель",
    SolarPanelDesc: "💡 Солнечные панели работают только 5 секунд из 10 - все циклы синхронизированы",
    WindTurbineDesc: "💡 Ветрогенераторы работают только 8 секунд из 10 - циклы не синхронизированы",
    Movie: "Фильм",
    ...
    ConsiderIncreaseProduction: "💡 Возможно, стоит увеличить производство ресурса: %{resource}",
    ...
    MaxInputDistance: "Максимальное расстояние ввода",
    MaxInputDistanceDesc:
        "Максимальное расстояние, на котором это здание может получить ресурсы для работы, измеряется в количестве плиток",
    AutoSellConcurrency: "Одновременная автопродажа",
    AutoSellConcurrencyDesc: "Максимальное количество ресурсов, которое может автоматически продаваться за раз",
    ...
    RatingHold: "Удерживание",
    RatingOutperform: "Повышение",
    RatingUnderperform: "Понижение",
    StockRating: "Стоимость ценных бумаг",
    JetEngine: "Реактивный двигатель",
    Helicopter: "Вертолёт",
    Lithium: "Литий",
    LithiumMine: "Литиевый рудник",
    LiionBatteryFactory: "Завод литий-ионных батарей",
    HelicopterFactory:"Вертолётостроительный завод",
    Satellite: "Спутник",
    ...
    PerMin: "%{amount}/мин",
    OfflineEarningTime: "Время заработка в офлайне",
    OfflineEarningTimeDesc: "Максимальное время в офлайн, в течение которого вы будете получать доход",
    BuyPermit: "Купить разрешение",
    Settings: "Настройки",
    Sound: "Звуковые эффекты",
    SoundDesc: "Включите звуковые эффекты, как, например, щелчок или звук ошибки",
    MusicDesc: "Включить музыку: It's Not Over 'Til The Bossa Nova — Shane Ivers (https://www.silvermansound.com)",
    Credits: "Дополнительная информация",
    Icons: "Иконки",
    MisplacedBuilding: "⛔ %{building} — это здание размещено не над подходящем месторождении",
    ...
    NBuildingsAreHighlighted: "Зданий выделено: %{n}",
    TurnOffProduction: "Остановка",
    TurnOffProductionDesc:
        "Остановить производство в здании. Оно больше не будет транспортировать ресурсы и потреблять энергию",
    ...
    InputStrategyFar: "Наиболее удалённый",
    InputStrategyFarDesc: "Отдавать предпочтение наиболее удалённому складу, имеющему достаточное количество ресурсов",
    InputStrategyAmount: "Количество ресурсов",
    ...
    SoftwareCompany: "Студия разработки",
    ...
    ClaimOfflineEarning: "Забрать офлайн заработок",
    OfflineTime: "Время работы в офлайне",
    Minutes: "%{time} мин.",
    MaxUpgrade: "Максимальная модернизация",
    MaxUpgradeDesc: "Здание полностью модернизировано.",
    ...
    BuildSearchPlaceholder: "Введите название здания или ресурса",
    ...
    NextOrderIn: "Получение нового заказа",
    ...
    OrderFilled: "Заказ %{from} был успешно выполнен!",
    PolicyCenter: "Политический центр",
    NewOrder: "Получен новый заказ от %{from}, проверьте его в Оптовом центре",
    Policies: "Политика",
    PolicyNotEnoughTime: "У вас недостаточно очков для этой политики",
    WholesaleCenterOrderFasterDesc:
        "Центр оптовых продаж получает заказы в 2 раза быстрее, а их объём в 2 раза больше",
    PolicyOilWellPowerx2: "Перегрузка нефтяных скважин",
    ...
    FreeOilTransportDesc: "Перевозка нефти не тратят топливо, но нефтяные скважины потребляют в 2 раза больше энергии",
    ...
    CostSaverDesc: "Если расходы на производство продукции превышают доходы, производство остановится",
    ...
    AdjacentBonusOnlyOutputDesc:
        "Смежный бонус не требует больше входных ресурсов, но использует больше энергии и эффективен только на 50%",
    IronMine2xOutput: "Тяжелый металл",
    IronMine2xOutputDesc: "Железные рудники производят в 2 раза больше железа, но и транспортировка в 2 раза дороже",
    ...
    SteelScience: "Знания через сталь",
    ...
    ShoppingSpreeDesc:
        "Если ресурса не хватает, автоматически покупается недостающее количество в Торговом центре (если включена автоматическая продажа такого ресурса, покупка будет проигнорирована).",
    ShoppingSpreeTradeCenterDesc:
        "💡 Политика шопинга включена, Центр торговли будет автоматически закупать ресурсы в условиях дефицита",
    ...
    NextTutorial: "Далее",
    Tutorial1:
        "Industry Idle — игра по <em>управлению ресурсами</em>, в которой вы строите фабрики🏭, производите товары📦 и зарабатываете деньги💸.<br><br>Давайте разберём некоторые аспекты, чтобы вы могли начать — это не займет много времени, я обещаю.",
    Tutorial2:
        "Все здания нуждаются в электроэнергии⚡, у вас есть <em>ветровой генератор</em>, он производит энергию. Вы можете увидеть её текущий запас в левой части верхней панели.<br><br>Вы, наверное, заметили, что ветровке генераторы работают только <em>80%</em> времени. Вы сможете построить другие электростанции, которые генерируют постоянную энергию, позже.",
    Tutorial3:
        "На карте разбросаны множество <em>месторождений</em>. Чтобы добывать ресурсы, вы должны построить соответствующие шахты⛏️ <em>над месторождениями</em>.<br><br>Например, у вас есть <em>нефтяная скважина🛢️</em> которая добывает <em>нефть</em> из нефтяного месторождения.<br></br>Запасы ресурсов в месторождения неограничены - не нужно беспокоиться о том, что они иссякнут. Помимо шахт, на любой пустой клетке можно построить и другие здания.",
    Tutorial5:
        "Чтобы заработать деньги, вам нужно экспортировать свои ресурсы через Центр торговли. Для этого просто включите <em>автопродажу</em> для этого ресурса.<br></br>Вы также можете и покупать ресурсы здесь. Помните, <em>если вы покупаете ресурс, вы повышает его цену</em>, а если продаёте, то понижаете.<br><br>Рынок <em>волатилен</em> — цены📈 регулярно меняются",
    Tutorial6:
        "Чтобы построить новые здания, вам нужно сначала разблокировать их в <em>исследовательской лаборатории🧪</em>. Лаборатория также преобразует науку в исследовательские единицы.<br><br>Ваш ветровой генератор (и другие электростанции) производит небольшое количество науки во время работы. Вы также можете построить школу🏫 и другие особые здания, чтобы впоследствии стимулировать науку.<br><br>Теперь, когда вы изучили все основы, пора строить свою экономику! Вот немного <em>денег💸</em> и <em>бензина⛽</em> для лёгкого старта.",
    WelcomePlay: "Играть",
    WelcomePlayMuted: "Играть (🔇Музыка)",
    Chat: "Чат",
    RestoreFromBackup: "Восстановление из резервной копии",
    RestoreFromBackupFail:
        "Не удалось восстановить резервную копию из облака Steam. Вы уверены, что она существует?",
    RestoreFromBackupTitle: "Вы уверены?",
    RestoreFromBackupDesc:
        "Обычно восстановление из облачной резервной копии не требуется, если только не потеряно локальное сохранение. Облачные резервные копии немного старее локальных сохранение.",
    ChangeName: "Изменить",
    SaveName: "Сохранить",
    ...
    ChatMessageRateLimit: "Вы можете отправлять сообщения в чате только раз в 10 секунд",
    ...
    Tips5: "Здания будут перевозить ресурс из Центра торговли, только если для этого ресурса отключена автоматическая продажа",
    Tips6: "Вы можете увидеть стоимость топлива для ресурса в соответствующем разделе входа ресурсов",
    ...
    Tips11: "Не забывайте всегда проверять запасы электроэнергии и топлива перед расширением производства",
    ...
    LeaderboardOptInDesc:
        "Ваши данные должны быть сброшены перед тем, как включить вас обратно в Таблицу лидеров. Вы уверены?",
    RewardAdsFailed: "Видео с вознаграждением не было завершено",
    OfflineEarningDoubleSuccess: "Вы удвоили свой оффлайн заработок",
    FPS30Desc:
        "Включение режима энергосбережения будет запускать игру с частотой 30FPS вместо 60FPS. Это позволит вашему аккумулятору работать дольше.",
    ...
    SwissMoney: "%{money} 💵",
    PrestigeDesc: "Начав в новом городе, вы получите %{money} 💵",
    ...
    RestartDesc: "💡 Хотите просто начать заново? Вы можете нажать на Начать в Новом Городе выше и выбрать ваш текущий город",
    ...
    PrestigeAlertContent:
        "Ваша компания будет ликвидирована. Вы получите %{amount} швейцарских денег и начнете новую компанию в %{city}",
    PrestigeCurrencyDesc:
        "Это деньги на вашем секретном счете в Швейцарском банке, которые вы можете брать с собой, когда начинаете работать в новом городе",
    Prestige: "Наличные",
    Cancel: "Отменить",
    ...
    PowerBankBuildDesc: "Накопление избыточной энергии и обеспечение ею во время ее дефицита",
